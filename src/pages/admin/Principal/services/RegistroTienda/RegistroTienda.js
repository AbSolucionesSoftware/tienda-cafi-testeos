...
import { Form, Input, Divider, Button, Upload, notification, Alert, Steps, message  } from 'antd';
	...
	const steps = [
		{
			...
			<div className="" setCurrent={setCurrent} current={current}>
				<Form onFinish={SendForm} form={form} onFinishFailed={onError} setCurrent={setCurrent} current={current}>
					<div className="row">
		...
		},
		{
			...
			content: (
				// drawnerClose ={drawnerClose}  setReloadInfo={setReloadInfo}
				<div>
					<PoliticasEnvio datosNegocio={datosNegocio}  setCurrent={setCurrent} current={current}/>
				</div>
			)
		},
		{
